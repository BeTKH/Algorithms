public class theLongestSubstringOfOne {

    public static void main(String[] args) {

        String binarySeq = "1101100111";


        int ans = findLength(binarySeq);
        System.out.println("The longest substring in "+binarySeq+" that meets the constarint is: "+ans);
